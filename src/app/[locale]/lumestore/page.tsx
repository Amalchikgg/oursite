  ...
  return (
    <Container>
      ...
      <div className='relative mb-[62px] mobile:mb-5'>
        <Image
          src={"/assets/icons/lumeBunner.svg"}
          alt='eats'
          width={1872}
          height={616}
        ...
        />
        <Image
          src={"/assets/icons/lumeStoreDesktop.svg"}
          alt='eats'
          width={1392}
          height={616}
        ...
        />
        <Image
          src={"/assets/icons/storeMobileBunner.svg"}
          alt='eats'
          width={343}
          height={285}
      ...
      <Image
        src={"/assets/icons/storeCase1.svg"}
        alt='storeCase'
        width={1872}
        height={1101}
      ...
      />
      <Image
        src={"/assets/icons/storeCaseMobile1.svg"}
        alt='storeCase'
        width={343}
        height={244}
      ...
      <div className='flex items-center gap-5 my-5 mobile:gap-3'>
        <Image
          src={"/assets/icons/storeCase2.svg"}
          alt='storeCase'
          width={924}
          height={1101}
        ...
        />
        <Image
          src={"/assets/icons/storeCase3.svg"}
          alt='storeCase'
          width={928}
          height={1101}
      ...
      <Image
        src={"/assets/icons/storeCase4.svg"}
        alt='storeCase'
        width={1872}
        height={1101}
      ...
      />
      <Image
        src={"/assets/icons/storeCase5.svg"}
        alt='storeCase'
        width={1872}
        height={1101}
      ...
      <div className='flex items-center gap-5 mb-[170px] mobile:gap-4'>
        <Image
          src={"/assets/icons/storeCase6.svg"}
          alt='storeCase'
          width={1205}
          height={1101}
          className='desktop:hidden'
        />
        <Image
          src={"/assets/icons/storeCaseDesktop6.svg"}
          alt='storeCase'
          width={802}
          height={742}
        ...
        />
        <Image
          src={"/assets/icons/storeCaseTablet6.svg"}
          alt='storeCase'
          width={348}
          height={449}
        ...
        />
        <Image
          src={"/assets/icons/storeCase7.svg"}
          alt='storeCase'
          width={647}
          height={1101}
          className='desktop:hidden'
        />
        <Image
          src={"/assets/icons/storeCaseDesktop7.svg"}
          alt='storeCase'
          width={566}
          height={745}
